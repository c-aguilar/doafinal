...
Public Class Sch_ProductionPlanDailyLow
...
#Region "Functions"
    ...
    Private Sub LoadProductionPlan()
        ...
        If Not selected_family = "" Then
            ...
            ds_production_plan.Tables.Add(GetMaterialWithPastDueAndStock(from_day, to_day, selected_business, selected_family))
            'ds_production_plan.Tables.Add(GetCapacities(from_day, from_day.AddDays((weeks_toShow * 7) - 1), selected_business, selected_family))
            ds_production_plan.Tables.Add(GetProduction(from_day, to_day, selected_business, selected_family))
            ds_production_plan.Tables.Add(GetRequirements(True, from_day, to_day, selected_business, selected_family, False, False))
            ds_production_plan.Tables.Add(GetRequirements(False, from_day, to_day, selected_business, selected_family, False, False))
            ds_production_plan.Tables.Add(GetWorkingShifts(from_day, to_day))
            ds_production_plan.Tables.Add(GetLastWksRequeriments(selected_business, selected_family))
    ...
    Private Function GetMaterialWithPastDueAndStock([from] As Date, [to] As Date, selected_business As String, selected_family As String) As DataTable
        ...
        Dim query As String = ""
        If selected_business = "" Then
            query = String.Format(My.Resources.PP_MaterialsByFamily, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_family, "Low")
        Else
            query = String.Format(My.Resources.PP_MaterialsByBusiness, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_business, "Low")
        End If
    ...
    Private Function GetRequirements(average As Boolean, [from] As Date, [to] As Date, selected_business As String, selected_family As String, saturdays As Boolean, sundays As Boolean) As DataTable
        ...
        If average Then
            ...
            End If
            If selected_business = "" Then
                requirements = SQL.Current.GetDatatable(String.Format(My.Resources.PP_AverageRequirementsByFamily, wkd1, wkd2, divider, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_family, "Low"))
            Else
                requirements = SQL.Current.GetDatatable(String.Format(My.Resources.PP_AverageRequirementsByBusiness, wkd1, wkd2, divider, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_business, "Low"))
            End If

        Else
            If selected_business = "" Then
                requirements = SQL.Current.GetDatatable(String.Format(My.Resources.PP_RequirementsByFamily, from.ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_family, "Low"))
            Else

                requirements = SQL.Current.GetDatatable(String.Format(My.Resources.PP_RequirementsByBusiness, from.ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_business, "Low"))
            End If
        End If
    ...
    Private Function GetProduction([from] As Date, [to] As Date, selected_business As String, selected_family As String) As DataTable
        ...
        If selected_business = "" Then
            production = SQL.Current.GetDatatable(String.Format(My.Resources.PP_EPSProductionByFamily, from.ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_family, "Low"))
        Else

            production = SQL.Current.GetDatatable(String.Format(My.Resources.PP_EPSProductionByBusiness, from.ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_business, "Low"))
        End If
    ...
    Private Function GetProductionPlan([from] As Date, [to] As Date, selected_business As String, selected_family As String) As DataTable
        ...
        If selected_business = "" Then
            pp_table = SQL.Current.GetDatatable(String.Format(My.Resources.PP_ByFamily, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_family, "Low"))
        Else
            pp_table = SQL.Current.GetDatatable(String.Format(My.Resources.PP_ByBusiness, [from].ToString("yyyy-MM-dd"), [to].ToString("yyyy-MM-dd"), selected_business, "Low"))
        End If
