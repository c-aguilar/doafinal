Public Class UserRights
    ...
    Private Sub UserRights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        GF.FillCombobox(UserRights_Username_cbo, SQL.Current.GetDatatable("SELECT FirstName + ' ' + LastName AS FullName,Username FROM Sys_Users ORDER BY FirstName + ' ' + LastName"), "FullName", "Username")
    End Sub
    ...
    Private Sub LoadData()
        Try
            ...
            For Each col In CurrentTable.ReadOnlyColumns
                If dgvData.Columns.Contains(col.ToString) Then
