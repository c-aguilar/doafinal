Public Class SMK_Operators
    ...
    Private Sub Save_btn_Click(sender As Object, e As EventArgs) Handles Save_btn.Click
                    ...
                    If Firstname_txt.Text <> "" AndAlso Lastname_txt.Text <> "" Then
                        If SQL.Current.Exists("Smk_Operators", "Badge", Badge_txt.Text) Then
                            ...
                            ElseIf SQL.Current.Exists("Smk_Operators", {"Badge", "Active"}, {Badge_txt.Text, 0}) Then
                                SQL.Current.Update("Smk_Operators", {"Firstname", "Lastname", "Shift", "Active", "Area"}, {Firstname_txt.Text, Lastname_txt.Text, Shift_cbo.SelectedValue, 1, "SMK"}, "Badge", Badge_txt.Text)
                                Delta.SaveUserPhoto(Badge_txt.Text, Picture_pb.Image)
                                Clean()
                                FlashAlerts.ShowConfirm("Registrado.")
                            Else
                            ...
                            End If
                        Else
                            If SQL.Current.Insert("Smk_Operators", {"Badge", "Firstname", "Lastname", "Area", "Shift"}, {Badge_txt.Text, Firstname_txt.Text, Lastname_txt.Text, "SMK", Shift_cbo.SelectedValue}) Then
                                Delta.SaveUserPhoto(Badge_txt.Text, Picture_pb.Image)
                                Clean()
                                GetOperators()
                                FlashAlerts.ShowConfirm("Registrado.")
        ...
        Else
            If Shift_cbo.SelectedIndex > -1 Then
                If Firstname_txt.Text <> "" AndAlso Lastname_txt.Text <> "" Then
                    SQL.Current.Update("Smk_Operators", {"Firstname", "Lastname", "Shift", "Active", "Area"}, {Firstname_txt.Text, Lastname_txt.Text, Shift_cbo.SelectedValue, 1, "SMK"}, "Badge", Badge_cbo.SelectedValue)
