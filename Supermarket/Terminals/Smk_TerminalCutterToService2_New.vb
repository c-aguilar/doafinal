...
Public Class Smk_TerminalCutterToService2_New
    ...
    Private Sub ReadCommmad()
        ...
        Else
            If My.Settings.Warehouse <> Serial.Warehouse Then
                If Serial.CutterToService(Serial.CurrentQuantity, SupermarketCable.CurrentBadge) AndAlso Serial.TransferService(RawMaterial.GetServiceLocation(Serial.Partnumber, My.Settings.Warehouse), My.Settings.Warehouse, SupermarketCable.CurrentBadge) Then
