Public Class ReportViewer
    ...
    Private Sub ReportViewer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        GF.FillCombobox(cboTable, SQL.Current.GetDatatable("SELECT Name FROM Sys_Reports"))
    End Sub
    ...
    Private Sub btnGet_Click(sender As Object, e As EventArgs) Handles btnGet.Click
        ...
        data = SQL.Current.GetDatatable(SQL.Current.GetString("Query", "Sys_Reports", "Name", cboTable.SelectedItem, ""))
